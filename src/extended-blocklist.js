...
export const extendedConfusableChars = extendedExplicitChars

export const extendedConfusableSet = new Set(extendedExplicitChars)

export function isExtendedConfusableChar(char) {
