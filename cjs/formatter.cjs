 ...
 * @returns {string}
 */
function formatMinimal(results, stats) {
  let output = [];
 ...
 * @returns {string}
 */
function formatVerbose(results, stats) {
  let output = [];
 ...
 * @returns {string}
 */
function formatSuccess(stats, verbose = false) {
  let output = [];
...
exports.formatMinimal = formatMinimal;
exports.formatSuccess = formatSuccess;
exports.formatVerbose = formatVerbose;
