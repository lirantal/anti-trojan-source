 ...
 */
function isFormatChar(codePoint) {
 ...
 */
function isSuspiciousByCategory(char) {
...
function getCharacterName(codePoint) {
  const names = new Map([
    ...
    // Extended blocklist (opt-in): names for reporting
    [0x2800, 'BRAILLE PATTERN BLANK'],
    [0x3130, 'HANGUL LETTER FILLER'],
...
exports.ALLOWED_CONTROL_CHARS = ALLOWED_CONTROL_CHARS;
exports.getCategoryName = getCategoryName;
exports.getCharacterName = getCharacterName;
exports.isControlChar = isControlChar;
exports.isFormatChar = isFormatChar;
exports.isSuspiciousByCategory = isSuspiciousByCategory;
